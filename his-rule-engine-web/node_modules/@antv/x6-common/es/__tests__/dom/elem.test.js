...
const svgContent = '<path id="svg-path" d="M10 10"/>' +
    ...
    '</body>' +
    '</foreignObject>';
Vector.create('svg', { id: 'svg-container' }, Vector.createVectors(svgContent)).appendTo(wrap);
    ...
    describe('elem', () => {
        ...
        describe('#isSVGGraphicsElement', () => {
            it('should return true when the given element is a SVGGraphicsElement', () => {
                expect(Dom.isSVGGraphicsElement(Vector.create('circle').node)).toBe(true);
            ...
            it('should return false when the given element is not a SVGGraphicsElement', () => {
                ...
                expect(Dom.isSVGGraphicsElement(Vector.create('linearGradient').node)).toBe(false);
            });
        });
        describe('#index', () => {
        ...
        describe('#tagName', () => {
            it('should return the correct tagName with lowercase', () => {
                ...
                expect(Vector.create(svgLinearGradient).tagName()).toEqual('lineargradient');
            });
        ...
        describe('#findParentByClass', () => {
            ...
            it('should stopped early', () => {
                const found1 = Vector.create(svgGroup3).findParentByClass('group-1', svgGroup2);
                expect(found1 == null).toBe(true);
                const found2 = Vector.create(svgGroup3).findParentByClass('group-1', svgCircle);
        ...
        describe('#contains', () => {
            it('...', () => {
                ...
                expect(Vector.create(svgGroup1).contains(document)).toBe(false);
            });
        });
        describe('#empty', () => {
        ...
        describe('#append', () => {
            const group = Vector.create(Dom.createElement('g'));
