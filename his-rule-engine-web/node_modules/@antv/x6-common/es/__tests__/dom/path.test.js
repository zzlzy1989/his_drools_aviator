    ...
    describe('path', () => {
        ...
        describe('#createSlicePathData', () => {
            it('should return the path string of a part of sector', () => {
                expect(Dom.createSlicePathData(5, 10, 0, Math.PI / 2)).toBe('M10,0A10,10 0 0,1 6.123233995736766e-16,10L3.061616997868383e-16,5A5,5 0 0,0 5,0Z');
            });
        });
    });
});
