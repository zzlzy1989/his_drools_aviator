...
describe('Object', () => {
    ...
    describe('#getValue', () => {
        it('should return a value of a object', () => {
            expect(ObjectExt.getValue(obj, 'name')).toBe('x6');
            expect(ObjectExt.getValue(obj, 'age')).toBe(1);
            expect(ObjectExt.getValue(obj, 'gender')).toBe(null);
            expect(ObjectExt.getValue(obj, 'count')).toBe(undefined);
        });
