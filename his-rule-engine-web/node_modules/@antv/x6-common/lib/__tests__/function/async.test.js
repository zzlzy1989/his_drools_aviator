...
describe('async', () => {
    describe('#toDeferredBoolean', () => {
        it('should return a promise resloved true when input is true or truthy promise', () => __awaiter(void 0, void 0, void 0, function* () {
            let ret = yield function_1.FunctionExt.toDeferredBoolean(Promise.resolve(true));
            expect(ret).toBeTruthy();
            ret = yield function_1.FunctionExt.toDeferredBoolean(true, [true], Promise.resolve(true));
            expect(ret).toBe(true);
        }));
        it('should return a promise resloved false when some input is falsy', () => __awaiter(void 0, void 0, void 0, function* () {
            const ret = yield function_1.FunctionExt.toDeferredBoolean(true, [true], Promise.resolve(false));
