    ...
    describe('path', () => {
        describe('#toPath', () => {
            it('should convert SVGPathElement', () => {
                const path = vector_1.Vector.create('path', { d: 'M 100 50 L 200 150' });
        ...
        describe('#toPathData', () => {
            ...
            it('should throw an exception on convert an invalid SvgElement', () => {
                expect(() => {
                    const group = vector_1.Vector.create('<group/>');
                    dom_1.Dom.toPathData(group.node);
                }).toThrowError();
            });
            it('should convert SVGPathElement', () => {
                const path = vector_1.Vector.create('path', { d: 'M 100 50 L 200 150' });
            ...
            it('should convert SVGLineElement', () => {
                const line = vector_1.Vector.create('line', {
                    x1: 100,
                    y1: 50,
                    x2: 200,
                    y2: 150,
            ...
            it('should convert SVGRectElement', () => {
                const rect = vector_1.Vector.create('rect', {
                    x: 100,
                    y: 50,
                    width: 200,
                    height: 150,
            ...
            it('should convert SVGCircleElement', () => {
                const circle = vector_1.Vector.create('circle', { cx: 100, cy: 50, r: 50 });
            ...
            it('should convert SVGEllipseElement', () => {
                const ellipse = vector_1.Vector.create('ellipse', {
                    cx: 100,
                    cy: 50,
                    rx: 100,
                    ry: 50,
        ...
        describe('#createSlicePathData', () => {
            it('should return the path string of a part of sector', () => {
                expect(dom_1.Dom.createSlicePathData(5, 10, 0, Math.PI / 2)).toBe('M10,0A10,10 0 0,1 6.123233995736766e-16,10L3.061616997868383e-16,5A5,5 0 0,0 5,0Z');
            });
        });
    });
});
