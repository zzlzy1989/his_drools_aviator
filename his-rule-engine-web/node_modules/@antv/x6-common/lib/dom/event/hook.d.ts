...
export declare namespace EventHook {
    function get(type: string): EventHook;
    function register(type: string, hook: EventHook): void;
...
export interface EventHook {
     ...
     *
     */
    setup?: (elem: Store.EventTarget, data: any, namespaces: string[], eventHandle: EventHandler<Store.EventTarget, any>) => any | false;
    /**
     ...
     *
     */
    teardown?: (elem: Store.EventTarget, namespaces: string[], eventHandle: EventHandler<Store.EventTarget, any>) => any | false;
    /**
     ...
     *
     */
    trigger?: (elem: Store.EventTarget, event: EventObject, data: any) => any | false;
    /**
     ...
     */
    preventDefault?: (elem: Store.EventTarget, event: EventObject, data: any) => any | false;
