...
describe('Point', () => {
    ...
    describe('#Point.equals', () => {
        ...
        it('should return false when the given two points are not equal', () => {
            ...
            expect(Point.equals(p1, null)).toBeFalsy();
    ...
    describe('#Point.equalPoints', () => {
        ...
        it('should return false when the given points array are not equal', () => {
            ...
            expect(Point.equalPoints(null, [p2])).toBeFalsy();
            expect(Point.equalPoints([p1], null)).toBeFalsy();
    ...
    describe('#scale', () => {
        ...
        it('should scale point with the given amount and center ', () => {
            expect(new Point(20, 30).scale(2, 3, new Point(40, 45))).toEqual(new Point(0, 0));
        });
    });
    describe('#closest', () => {
    ...
    describe('#move', () => {
        it('should move the point on a line that leads to another point `ref` by a certain `distance`.', () => {
            expect(new Point(1, 1).move({ x: 1, y: 0 }, 5).round(0)).toEqual(new Point(1, 6));
        });
    });
    describe('#reflection', () => {
        it('should return a point that is the reflection of me with the center of inversion in `ref` point.', () => {
            expect(new Point(1, 0).reflection({ x: 1, y: 1 }).round(0)).toEqual(new Point(1, 2));
        });
    });
    describe('#cross', () => {
        ...
        it('shoule return `NAN` when any of the given point is null', () => {
            expect(new Point().cross(null, new Point(1, 2))).toBeNaN();
        });
    });
    describe('#dot', () => {
