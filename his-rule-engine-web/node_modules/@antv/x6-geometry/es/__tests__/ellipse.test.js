...
describe('ellipse', () => {
    ...
    describe('#intersectsWithLine', () => {
        ...
        it('should return the intersections with line', () => {
            expect(Point.equalPoints(ellipse.intersectsWithLine(new Line(0, -5, 0, 5)), [
                { x: 0, y: -4 },
                { x: 0, y: 4 },
            ])).toBeTruthy();
            expect(Point.equalPoints(ellipse.intersectsWithLine(new Line(0, 0, 0, 5)), [
                { x: 0, y: 4 },
            ])).toBeTruthy();
            expect(Point.equalPoints(ellipse.intersectsWithLine(new Line(3, 0, 3, 4)), [
                { x: 3, y: 0 },
            ])).toBeTruthy();
        });
