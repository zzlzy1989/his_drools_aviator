...
describe('Line', () => {
    ...
    describe('#scale', () => {
        ...
        it('should scale line with the given amount and center ', () => {
            expect(new Line(1, 2, 3, 4).scale(2, 3, new Point(40, 45)).serialize()).toEqual('-38 -84 -34 -78');
        });
    });
    describe('#rotate', () => {
    ...
    describe('#parallel', () => {
        it('should return the parallel line', () => {
            expect(new Line(0, 0, 2, 0).parallel(10).round().serialize()).toEqual('0 10 2 10');
            expect(new Line(0, 0, 0, 2).parallel(10).round().serialize()).toEqual('-10 0 -10 2');
        });
    ...
    describe('#closestPointNormalizedLength', () => {
        ...
        it('should return o when the line has zero length', () => {
            expect(new Line(1, 2, 1, 2).closestPointNormalizedLength([1, 1])).toEqual(0);
        });
    });
    describe('#pointAt', () => {
    ...
    describe('#pointOffset', () => {
        it('should return the perpendicular distance', () => {
            const offset = (x1, y1, x2, y2, x, y) => new Line(x1, y1, x2, y2).pointOffset({ x, y });
    ...
    describe('#equals', () => {
        it('should return true when the given lines has the same start and end points', () => {
            expect(new Line(1, 2, 3, 4).equals(new Line([1, 2], [3, 4]))).toEqual(true);
        });
        it('should return false when the given lines has different start or end point', () => {
            expect(new Line(1, 2, 3, 4).equals(new Line([1, 2], [3, 40]))).toEqual(false);
        });
    });
});
