...
describe('Polyline', () => {
    describe('#constructor', () => {
        it('should create a new Polyline object', () => {
            const polyline = new __1.Polyline();
            expect(polyline).toBeInstanceOf(__1.Polyline);
        ...
        it('should create a new Polyline object with points array', () => {
            const polyline = new __1.Polyline([new __1.Point(1, 1), new __1.Point(2, 2)]);
            expect(polyline).toBeInstanceOf(__1.Polyline);
            expect(Array.isArray(polyline.points)).toEqual(true);
        ...
        it('should create a new Polyline object with points string', () => {
            const polyline = new __1.Polyline('1,1 2,2');
            expect(polyline).toBeInstanceOf(__1.Polyline);
            expect(Array.isArray(polyline.points)).toEqual(true);
            expect(polyline.points.length).toEqual(2);
            expect(polyline.points[0].serialize()).toEqual('1 1');
    ...
    describe('Polyline.parse()', () => {
        it('should create a new Polyline object from empty string', () => {
            const polyline = __1.Polyline.parse('');
            expect(polyline).toBeInstanceOf(__1.Polyline);
            expect(Array.isArray(polyline.points)).toEqual(true);
            expect(polyline.points.length).toEqual(0);
        });
        ...
        it('should create a new Polyline object from svg points string', () => {
            const polyline = __1.Polyline.parse('1,1 2,2');
            expect(polyline).toBeInstanceOf(__1.Polyline);
            expect(Array.isArray(polyline.points)).toEqual(true);
            expect(polyline.points.length).toEqual(2);
            expect(polyline.points[0].serialize()).toEqual('1 1');
    ...
    describe('Polyline.isPolyline()', () => {
        it('should return true when the given instance is a ployline', () => {
            expect(__1.Polyline.isPolyline(new __1.Polyline())).toEqual(true);
        });
        it('should return false when the given instance is not a ployline', () => {
            expect(__1.Polyline.isPolyline(null)).toEqual(false);
            expect(__1.Polyline.isPolyline(new __1.Point())).toEqual(false);
        });
    });
    describe('#start', () => {
    ...
    describe('#scale()', () => {
        it('should scale the polyline', () => {
            const polyline1 = new __1.Polyline();
            const polyline2 = new __1.Polyline([
                [10, 0],
                [10, 10],
                [20, 10],
                [20, 0],
            ...
            expect(polyline1.clone().scale(10, 10, new __1.Point(10, 10)).serialize()).toEqual('');
            expect(polyline2.clone().scale(10, 10).serialize()).toEqual('100 0 100 100 200 100 200 0 100 0');
            expect(polyline2.clone().scale(10, 10, new __1.Point(10, 10)).serialize()).toEqual('10 -90 10 10 110 10 110 -90 10 -90');
        });
    });
    describe('#rotate()', () => {
        it('should rotate the polyline', () => {
            ...
            expect(polyline2.clone().rotate(90, new __1.Point(10, 10)).round(3).serialize()).toEqual('0 20 5 15');
        });
    });
    describe('#translate()', () => {
    ...
    describe('#clone()', () => {
        it('should return the cloned ellipse', () => {
            ...
            expect(polyline2).toBeInstanceOf(__1.Polyline);
    ...
    describe('#closestPointNormalizedLength()', () => {
        it('should return normalized length closest to a given point', () => {
            const point = new __1.Point(150, 150);
            let polyline = new __1.Polyline();
            expect(polyline.closestPointNormalizedLength(point)).toEqual(0);
            polyline = new __1.Polyline([[100, 100]]);
            expect(polyline.closestPointNormalizedLength(point)).toEqual(0);
            polyline = new __1.Polyline([
                [100, 100],
                [100, 100],
                [100, 100],
            ]);
    ...
    describe('#closestPointTangent()', () => {
        it('should return tangent at point closest to a given point', () => {
            const check = (points, d) => {
                var _a;
                expect((_a = new __1.Polyline(points)
    ...
    describe('#containsPoint()', () => {
        ...
        it('should return false when the polyline has zero length', () => {
            expect(new __1.Polyline().containsPoint([10, 10])).toEqual(false);
        });
    });
    describe('#intersectsWithLine()', () => {
        ...
        it('should return null when the polyline do not intersect with the given line', () => {
            expect(polyline.intersectsWithLine(new __1.Line([0, 20], [20, 20]))).toBeNull();
        });
        it('should return all intersections', () => {
            const ret = polyline.intersectsWithLine(new __1.Line([-5, 0], [15, 20]));
    ...
    describe('#isDifferentiable()', () => {
        ...
        it('should return false when the polyline is undifferentiable (can have tangents)', () => {
            expect(new __1.Polyline().isDifferentiable()).toEqual(false);
            expect(new __1.Polyline([[100, 100]]).isDifferentiable()).toEqual(false);
            expect(new __1.Polyline([
                [100, 100],
                [100, 100],
                [100, 100],
    ...
    describe('#pointAt()', () => {
        it('should return null when the polyline the empty', () => {
            expect(new __1.Polyline().pointAt(0.5)).toBeNull();
        });
        it('should return the only point when the polyline has only one point', () => {
            var _a, _b, _c, _d, _e;
            const polyline = new __1.Polyline([[10, 10]]);
    ...
    describe('#pointAtLength()', () => {
        it('should return null when the polyline the empty', () => {
            expect(new __1.Polyline().pointAtLength(5)).toBeNull();
        });
    ...
    describe('#tangentAt()', () => {
        it('should return null when the polyline is empty', () => {
            expect(new __1.Polyline().tangentAt(0)).toBeNull();
            expect(new __1.Polyline().tangentAt(0.5)).toBeNull();
            expect(new __1.Polyline().tangentAt(1)).toBeNull();
            expect(new __1.Polyline().tangentAt(100)).toBeNull();
        });
        it('should return null when the polyline has only one point', () => {
            expect(new __1.Polyline([[10, 10]]).tangentAt(0)).toBeNull();
            expect(new __1.Polyline([[10, 10]]).tangentAt(0.5)).toBeNull();
            expect(new __1.Polyline([[10, 10]]).tangentAt(1)).toBeNull();
            expect(new __1.Polyline([[10, 10]]).tangentAt(100)).toBeNull();
        });
    ...
    describe('#tangentAtLength()', () => {
        it('should return null when the polyline is empty', () => {
            expect(new __1.Polyline().tangentAtLength(5)).toBeNull();
            expect(new __1.Polyline().tangentAtLength(-5)).toBeNull();
        });
        it('should return null when the polyline has only one point', () => {
            expect(new __1.Polyline([[10, 10]]).tangentAtLength(5)).toBeNull();
            expect(new __1.Polyline([[10, 10]]).tangentAtLength(-5)).toBeNull();
        });
    ...
    describe('#simplify()', () => {
        const check = (points, d, threshold) => {
            expect(new __1.Polyline(points).simplify({ threshold }).serialize()).toEqual(d);
        };
    ...
    describe('#toHull()', () => {
        it('should return a convex hull', () => {
            expect(new __1.Polyline().toHull().serialize()).toEqual('');
            expect(new __1.Polyline('100 100').toHull().serialize()).toEqual('100 100');
            expect(new __1.Polyline('100 100 200 100').toHull().serialize()).toEqual('100 100 200 100');
            expect(new __1.Polyline('100 100 200 100 300 100').toHull().serialize()).toEqual('100 100 300 100');
            expect(new __1.Polyline('200 100 100 100 300 100').toHull().serialize()).toEqual('100 100 300 100');
            expect(new __1.Polyline('100 100 200 100 300 100 400 100').toHull().serialize()).toEqual('100 100 400 100');
            expect(new __1.Polyline('200 100 100 100 300 100 400 100').toHull().serialize()).toEqual('100 100 400 100');
            expect(new __1.Polyline('100 100 100 500').toHull().serialize()).toEqual('100 100 100 500');
            expect(new __1.Polyline('100 100 100 500 500 500').toHull().serialize()).toEqual('100 100 500 500 100 500');
            expect(new __1.Polyline('100 100 100 500 300 300 500 500 500 100')
                .toHull()
                .serialize()).toEqual('100 100 500 100 500 500 100 500');
            expect(new __1.Polyline('100 100 200 100 300 200 300 200 300 300')
                .toHull()
                .serialize()).toEqual('100 100 200 100 300 200 300 300');
            expect(new __1.Polyline('300 200 300 200 300 300 100 100 200 100')
                .toHull()
            ...
            expect(new __1.Polyline([
                new __1.Point(180, 80),
                new __1.Point(220, 80),
                new __1.Point(220, 120),
                new __1.Point(180, 120),
                new __1.Point(180, 280),
                new __1.Point(220, 280),
                new __1.Point(220, 320),
                new __1.Point(180, 320),
                new __1.Point(180, 380),
                new __1.Point(220, 380),
                new __1.Point(220, 420),
                new __1.Point(180, 420),
                new __1.Point(180, 180),
                new __1.Point(220, 180),
                new __1.Point(220, 220),
                new __1.Point(180, 220),
                new __1.Point(80, 380),
                new __1.Point(120, 380),
                new __1.Point(120, 420),
                new __1.Point(80, 420),
            ])
                .toHull()
                .serialize()).toEqual('180 80 220 80 220 420 80 420 80 380');
            expect(new __1.Polyline([
                new __1.Point(80, 80),
                new __1.Point(120, 80),
                new __1.Point(120, 120),
                new __1.Point(80, 120),
                new __1.Point(180, 80),
                new __1.Point(220, 80),
                new __1.Point(220, 120),
                new __1.Point(180, 120),
            ...
            expect(new __1.Polyline([
                new __1.Point(280, 280),
                new __1.Point(320, 280),
                new __1.Point(320, 320),
                new __1.Point(280, 320),
                new __1.Point(180, 280),
                new __1.Point(220, 280),
                new __1.Point(220, 320),
                new __1.Point(180, 320),
                new __1.Point(80, 180),
                new __1.Point(120, 180),
                new __1.Point(120, 220),
                new __1.Point(80, 220),
                new __1.Point(180, 80),
                new __1.Point(220, 80),
                new __1.Point(220, 120),
                new __1.Point(180, 120),
                new __1.Point(280, 80),
                new __1.Point(320, 80),
                new __1.Point(320, 120),
                new __1.Point(280, 120),
                new __1.Point(80, 80),
                new __1.Point(120, 80),
                new __1.Point(120, 120),
                new __1.Point(80, 120),
                new __1.Point(380, 80),
                new __1.Point(420, 80),
                new __1.Point(420, 120),
                new __1.Point(380, 120),
            ])
                .toHull()
    ...
    describe('#equals()', () => {
        it('should return true when the two polyline are the same', () => {
            expect(new __1.Polyline([
                [1, 1],
                [2, 2],
            ]).equals(new __1.Polyline('1 1 2 2'))).toEqual(true);
            expect(new __1.Polyline().equals(new __1.Polyline())).toEqual(true);
            expect(new __1.Polyline([]).equals(new __1.Polyline(''))).toEqual(true);
        });
        it('should return false when the given polyline is null ', () => {
            expect(new __1.Polyline().equals(null)).toEqual(false);
        });
        it('should return false when the given polyline do not have the same points count', () => {
            expect(new __1.Polyline([
                [1, 1],
                [2, 2],
            ]).equals(new __1.Polyline())).toEqual(false);
        });
    });
});
