...
class Anchor extends tool_1.ToolsView.ToolItem {
    get type() {
        return this.options.type;
    }
    onRender() {
        x6_common_1.Dom.addClass(this.container, this.prefixClassName(`edge-tool-${this.type}-anchor`));
    ...
    onMouseMove(evt) {
        ...
        if (typeof snapFn === 'function') {
            const tmp = x6_common_1.FunctionExt.call(snapFn, edgeView, coords, terminalView, terminalMagnet, terminalType, edgeView, this);
            coords = x6_geometry_1.Point.create(tmp);
        }
        ...
        if (typeof anchorFn === 'function') {
            anchor = x6_common_1.FunctionExt.call(anchorFn, edgeView, coords, terminalView, terminalMagnet, terminalType, edgeView, this);
        }
