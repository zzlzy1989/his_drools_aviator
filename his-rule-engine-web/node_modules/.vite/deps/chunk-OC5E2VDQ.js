...
function baseUnset(object, path) {
  ...
  while (++index < length) {
    var key = toKey_default(path[index]);
    if (key === "__proto__" && !hasOwnProperty18.call(object, "__proto__")) {
      return false;
    }
...
var omit = flatRest_default(function(object, paths) {
  ...
  if (isDeep) {
    result2 = baseClone_default(result2, CLONE_DEEP_FLAG3 | CLONE_FLAT_FLAG2 | CLONE_SYMBOLS_FLAG4, customOmitClone_default);
  }
...
var assign = createAssigner_default(function(object, source) {
  ...
  for (var key in source) {
    if (hasOwnProperty21.call(source, key)) {
...
lodash-es/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-OC5E2VDQ.js.map
